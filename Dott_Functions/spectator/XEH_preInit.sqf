/**
 * Spectator Module - CBA Pre-Init Settings
 *
 * Registers CBA settings for the spectator module:
 *     TN_autoSpectate - auto-enter spectator on respawn
 *     TN_limitSpectator - restriction level for spectator features
 *
 * Parameters:
