/**
 * Vehicle Module - CBA Pre-Init Settings
 *
 * Registers CBA settings for the vehicle module:
 *     TN_removeDefaultVehicleInventories - strip vehicle cargo
 *     TN_disableRHSEngineWarmup - disable RHS startup delay
 *     TN_autoAddFRIES - auto-equip FRIES on helicopters
 *     TN_artilleryComputer - toggle ACE artillery computer
 *
 * Parameters:
