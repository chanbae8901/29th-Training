...
//due to new marker creation below being delayed by 2 seconds by OCAP for whatever reason, we delay deletion by 2 seconds to make transition more seamless
...

{
    ...
    //make sure new marker name doesn't match old via time
